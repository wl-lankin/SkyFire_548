...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_SCENARIO_POI,                           0x1A22, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryScenarioPOIOpcode              ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_LOOT_SPECIALIZATION, 0x1260, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_CONFIRM_PURCHASE, 0x14E3, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERY_ENDED, 0x020B, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERY_STARTED, 0x1E32, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE, 0x043F, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE, 0x1ABF, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE, 0x023A, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_PURCHASE_UPDATE, 0x14E2, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE, 0x08AF, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_DISTRIBUTION_MAKE_PRODUCT_CHOICE_RESPONSE, 0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE, 0x0612, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_PLAY_HOVER_ANIM, 0x069F, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UNK_2590, 0x0A1E, STATUS_UNHANDLED); // uint8
    DEFINE_OPCODE_HANDLER(SMSG_UNK_4614, 0x1206, STATUS_UNHANDLED); // 2x ObjectGuid uint8
    DEFINE_OPCODE_HANDLER(SMSG_UNK_5345, 0x14E1, STATUS_UNHANDLED); // ClientGMCharacterRestoreResponse?
    DEFINE_OPCODE_HANDLER(SMSG_UNK_7731, 0x1E33, STATUS_UNHANDLED); // ReforgeHello?
